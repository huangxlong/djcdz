...
public class TickViewConfig implements Serializable {
    ...
    private void setupDefaultValue(Context context) {
        this.setUnCheckBaseColor(Color.parseColor("#3F51B5"))
                .setCheckBaseColor(Color.parseColor("#fff5d747"))
                .setCheckTickColor(Color.WHITE)
                .setRadius(DensityUtil.dip2px(context, 20))
                .setClickable(true)
                .setTickRadius(DensityUtil.dip2px(context, 12))
                .setTickRadiusOffset(DensityUtil.dip2px(context, 4))
